	...
	<div class="row-fluid">
		...
		<div class="span3">
			...
			<div class="data_list">
				...
				<div class="datas">
					<ul>
						<c:forEach var="diaryCoun" items="${diaryCounList}">
							<li><span><a href="main?s_releaseDateStr=${diaryCoun.releaseDateStr }">${diaryCoun.releaseDateStr }(${diaryCoun.diaryCount })</a></span></li>
						</c:forEach>
					</ul>
				</div>
			</div>
